...
public class AnyadirContacto extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AnyadirContacto frame = new AnyadirContacto();
...
//COPIAR SIEMPRE DE AQUI HASTA LA LINEA
		...
		lblNewLabel = new JLabel("A\u00F1adir  Contacto");
		...
		lblUneteANosotros = new JLabel("A\u00F1adir contacto");
		...
		lblRellenaLosCampos = new JLabel("Rellena los campos con los datos del nuevo contacto");
