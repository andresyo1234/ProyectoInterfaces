...
public class AgendaPrincipal_1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgendaPrincipal_1 frame = new AgendaPrincipal_1();
	...
	public AgendaPrincipal_1() {
		...
		botonAgenda.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				AgendaPrincipal_1 ag = new AgendaPrincipal_1();
				ag.setVisible(true);
		...
		botonAnadirContacto.setIcon(new ImageIcon(AgendaPrincipal_1.class.getResource("/Imagenes/s.png")));
		...
		botonEditarContacto.setIcon(new ImageIcon(AgendaPrincipal_1.class.getResource("/Imagenes/lupa.png")));
		...
		botonEliminarContacto.setIcon(new ImageIcon(AgendaPrincipal_1.class.getResource("/Imagenes/borrar.png")));
		...
		//QfotoMancha.setIcon(new ImageIcon(Login.class.getResource("/Imagenes/Ilustracion_sin_titulo_2.png")));
